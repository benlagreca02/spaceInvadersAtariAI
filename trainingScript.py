...
if __name__ == "__main__":
    # these were changed based on the model being trained
    ...
    # replay buffer tuned due to memory constraints
    # model = DQN("CnnPolicy", env, verbose=1, buffer_size=100000 ,tensorboard_log=LOG_DIR)
